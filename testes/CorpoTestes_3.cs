...
namespace parser
{
    class CorpoTestes_3
    {
        ...
        {
            expressoes = null;
            List<string> tokens3 = new Tokens(codigo3).GetTokens();
            ...
            expressoes = Expressao.ExtraiExpressoes(tokens3, escopo);
        }
        ...
        private void TesteParaDefinicaoDeObjetoComExpressoesEmAtribuicao(Assercoes assercao)
        {
            ...
            processador.escopo.tabela.RegistraFuncao(new Metodo("public", "funcaoA", funcaoVazia, null));
        ...
        private void TesteInstrucaoCreate(Assercoes assercao)
        {
            ...
            processador.Compilar(); // constroi a classe teste.

            Metodo umConstrutor = new Metodo("public", "ClasseB", funcaoVazia, null, new Objeto[] {
