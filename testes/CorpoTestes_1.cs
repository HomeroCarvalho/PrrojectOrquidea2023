...
namespace parser
{
    public class CorpoTestes_1
    {
        ...
        private void TesteGetTokensDeUmTrechoDeCodigo(Assercoes assercao)
        {
            ...
            List<string> todosTokens = new Tokens(trechoDeCodigo).GetTokens();
        ...
        private void TesteObterProducoesPelaClasseTokens(Assercoes assercao)
        {
            ...
            Tokens tokensProducao = new Tokens(programa);
        ...
        private static void FuncaoTesteExpressoes(Assercoes assercao, string expressaoInfixa, string expressaoPosFixaEsperada, List<string> codigo)
        {
            ...
            parserExpressao.PosOrdemExpressao();
            ...
            string expressaoGerada = Utils.OneLineTokens(parserExpressao.Convert());
        ...
        private void TesteObterProducoes(Assercoes assercao)
        {
            ...
            new Tokens(codigo).GetProducoes(tokens, new Escopo(codigo));
        ...
        private void TesteObterProducoesVersaoBeta(Assercoes assercao)
        {
            ...
            new Tokens(codigo).GetProducoes(tokens, processador.escopo);
        ...
        private void TesteProcessamentoDeClasses(Assercoes assercao)
        {
            ...
            ExtratoresOO extratores = new ExtratoresOO(escopo, tokens);
        ...
        private void TesteGetTokensPolemicos(Assercoes assercao)
        {
            ...
            List<string> tokens5 = new Tokens(codigo5).GetTokens();
            ...
            List<string> todosTokens3 = new Tokens(trechoDeCodigo3).GetTokens();
            ...
            List<string> todosTokens2 = new Tokens(trechoDeCodigo2).GetTokens();
