...
namespace parser.Manutencao
{
    public class CorpoTestesManutencao
    {
        ...
        private void TesteBuildInstrucoes(Assercoes assercao)
        {
            ...
            processaodoMultiplasInstrucoes.Compilar();
            ...
            processadorAtribuicacao.Compilar();
        ...
        private void TesteSalvarCarregarFuncaoEmArquivoXML(Assercoes assercao)
        {
            ...
            List<Metodo> funcao = processador.escopo.tabela.GetFuncao("funcaoA");
            ...
            Metodo funcaoLida = umMetodoXML_read.Read(null);
        ...
        private void testeBuildOperadorBinario(Assercoes assercao)
        {
            ...
            List<string> tokensDefinicaoOperador = new Tokens(new List<string>() { codigoDefinicaoOperador }).GetTokens();
            List<string> tokensFuncaoOperador = new Tokens(new List<string>() { codigoFuncaoOperador }).GetTokens();
        ...
        private void TesteTokensPolemicos(Assercoes assercao)
        {
            ...
            List<string> tokens = new Tokens(new List<string>() { codigo }).GetTokens();
        ...
        private void testeExtracaoDeExpressoes(Assercoes assercao)
        {
            ...
            List<string> tokensDaExpressao = new Tokens(new List<string>() { codigoExpressao }).GetTokens();
            ProcessadorDeID processador = new ProcessadorDeID(new List<string>() { codigo });
            processador.Compilar();


            List<Expressao> exprss = Expressao.ExtraiExpressoes(tokensDaExpressao, processador.escopo);
        ...
        private void testeChamadaDeMetodo(Assercoes assercao)
        {
            ...
            LinguagemOrquidea linguagem = LinguagemOrquidea.Instance();
            List<string> tokensDefinicaoDeClasse = new Tokens(new List<string>() { codigoDefinicaoDeClasse }).GetTokens();
            List<string> tokensDefinicaoDeObjeto = new Tokens(new List<string>() { codigoDefinicaoDeObjeto }).GetTokens();
            List<string> tokensChamadaDeFuncao = new Tokens(new List<string>() { codigoChamadaDeFuncao }).GetTokens();
        ...
        private void testePosicaoECodigoClasse(Assercoes assercao)
        {
            ...
            List<string> tokensParaLocalizar = new Tokens(tokensALocalizar).GetTokens();
        ...
        private void testeChamadaDeMetodoDeUmaClasseImportada(Assercoes assercao)
        {
            ...
            List<string> codigoObjetoDeClasseImportado = new Tokens(new List<string>() { objetoDeClasseImportado }).GetTokens();
            List<string> codigoChamadaDeMetodoImportado = new Tokens(new List<string>() { chamadaDeObjeto }).GetTokens();
            ...
            processadorChamadaDeMetodo.Compilar();
        ...
        private void TesteCalcExpressaoCenarioSimples(Assercoes assercao)
        {
            ...
            ProcessadorDeID processador = new ProcessadorDeID(codigo);
            processador.Compilar();
            List<Expressao> expressaoCalc = Expressao.ExtraiExpressoes(tokensExpressao, processador.escopo);

            expressaoCalc[0].PosOrdemExpressao();
        ...
        private void TesteCalcExpressaoCenarioComplexo(Assercoes assercao)
        {
            ...
            List<string> tokensExpressao = new Tokens(new List<string>() { expressaoTeste }).GetTokens();

            List<Expressao> expressaoComplexa = Expressao.ExtraiExpressoes(tokensExpressao, processador.escopo);
