...
namespace parser
{
    class CorpoTestes_2
    {
        ...
        private void TesteCalculoDeVariasSequenciasID(Assercoes assercao)
        {
            ...
            List<string> tokens = new Tokens(codigo1).GetTokens();
            int iteracoes = 0;
        ...
        private void TesteObterProducoes(Assercoes assercao)
        {
            ...
            List<Producao> producoes = new Tokens(codigo).GetProducoes(tokens, new Escopo(codigo));
            ...
            List<string> tokensSeq = new Tokens(codigoSequenciaID).GetTokens();
            List<Producao> producoesSeq = new Tokens(codigoSequenciaID).GetProducoes(tokensSeq, new Escopo(codigoSequenciaID));
        ...
        private void TesteExpressaoCondicionalResumida(Assercoes assercao)
        {
            ...
            List<string> tokensExpressaoCondicional = new Tokens(new List<string>() { expressaoCondicional_b }).GetTokens();
        ...
        private void TesteObtemValidarExpressaoGeralResumida(Assercoes assercao)
        {
            ...
            List<string> tokensDoCodigoTotal = new Tokens(codigoTotal).GetTokens();

            List<string> tokensDaExpressaoCasoUM = new Tokens(codigoExpressaoCenarioUM).GetTokens();

            ProcessadorDeID processador = new ProcessadorDeID(codigoTotal);
           

            processador.Compilar(); // criação de escopo (validação de variáveis, funções, classes, blocos, etc..).
...
///________________________________________________________________________________________________________________________________________________________________
            ...
            List<string> tokensDaExpressaoCasoDOIS = new Tokens(codigoExpressaoCenarioDOIS).GetTokens(); // teste com operadores unários e binários.
        ...
        private void TesteVariaveisVetor(Assercoes assercao)
        {
            ...
            escopoVariavelVetor.tabela.AddObjetoVetor("public", "a", "int", new int[] { 20 }, escopoVariavelVetor, false, "int");
        ...
        private void TesteEvalExpression(Assercoes assercao)
        {
            ...
            tokens = new Tokens(codigo).GetTokens();
        ...
        private void TesteExtracaoDeExpressoes(Assercoes assercoes)
        {
            ...
            List<Expressao> expressoes = Expressao.ExtraiExpressoes(tokens, escopo);
            ...
            string codigo2 = "c+b;";
            List<string> tokens2 = new Tokens(new List<string>() { codigo2 }).GetTokens();
            ...
            List<Expressao> expressoes2 = Expressao.ExtraiExpressoes(tokens2, escopo2);
        ...
        private void TesteExtracaoDeClasses(Assercoes assercao)
        {
            ...
            Escopo escopo = new Escopo(codigo);
            ExtratoresOO extrator = new ExtratoresOO(escopo, tokens);
