...
namespace parser
{
    public class Tokens
    {
        ...
        /// </summary>
        public Tokens(List<string> _codigo)
        {
            this.linguagem = LinguagemOrquidea.Instance();
        ...
        {
            this.linguagem = LinguagemOrquidea.Instance();
            this.codigo = new List<string>() { codigo };
            this.tokensTotal = new List<string>();
            this.MsgErros = new List<string>();
        }
        ...
        private List<Producao> ResumeProducoes(List<Producao> producao)
        {
            ...
            for (int x = 0; x < producao.Count; x++)
            {
                ...
                List<string> tokensDeUmaProducao = new Tokens(codigoProducao).GetTokens(); // obtem os tokens da maquina de estados da producao currente.
    ...
    public class TokenParser
    {
        ...
        {
            this.tokens = new Tokens(programa.ToList<string>()).GetTokens();
            this.index = 0;
        } // TokenParser()
