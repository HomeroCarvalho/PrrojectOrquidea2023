...
namespace parser
{
    public class ExtensionLanguage
    {
        ...
        private string str_sequencia_idRegex;
        ...
        public ExtensionLanguage(List<string> codigo, parser.ProcessadorDeID.MetodoTratador handlerBuilder, parser.ProgramaEmVM.HandlerInstrucao handlerRuns, int codeInstruction, string str_sequencia, string str_sequencia_idRegex)
        {
            ...
            this.str_sequencia_idRegex = str_sequencia_idRegex;
            this.str_sequencia_idRegex= str_sequencia_idRegex;
        ...
        {
            ProcessadorDeID.LoadHandler(this.handlerBuild, this.str_sequencia_idRegex); // carrega o builder da instrução!
