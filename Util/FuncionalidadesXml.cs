...
namespace parser
{
    ...
    {
        public Metodo Read(XElement raiz)
        {
            ...
            if (noNome.Attribute("isReflexao").Value.Equals("nao"))
            {
                ...
                {
                    Metodo funcaoLida = new Metodo(classeDaFuncao, "public", nomeFuncao, parametros.ToArray(), retornoDaFuncao, instrucoesDaFuncao, escopo);
                    return funcaoLida;
                }
                else
                    return null;
            ...
            {
                Metodo funcaoLida = new Metodo(retornoDaFuncao, acessorFuncao, nomeFuncao, parametros.ToArray(), retornoDaFuncao, new List<Instrucao>(), escopo);
                return funcaoLida;
            }
        ...
        public void Write(Metodo funcao, XElement root)
        {
            if (root == null)
                root = this.GetRootWriteMode();
        ...
        private XElement WriteALLParameters(Metodo funcao)
        {
    ...
    public class ExpressaoXML : FuncionalidadeXml
    {
        ...
        public Expressao Read(XElement raiz)
        {
            ...
            Expressao ExpressaLida2 = new ExpressaoElemento(expressaoXml.Value.ToString());
    ...
    public class ClasseXML : FuncionalidadeXml
    {
        ...
        public Classe Read(XElement root)
        {
            ...
            List<Metodo> metodosLidos = ReadMetodosDaClasse(rootMetodos);
        ...
        private List<Metodo> ReadMetodosDaClasse(XElement rootMetodos)
        {
            List<Metodo> metodosLidos = new List<Metodo>();
            ...
            if (mtdsXML != null)
                foreach (XElement noMetodo in mtdsXML)
                {
                    ...
                    Metodo funcaoLida = metodo.Read(rootMetodos);
        ...
        public void Write(XElement root)
        {
            ...
            List<Metodo> metodosDaClasse = this._classe.GetMetodos();
        ...
        private void WriteMetodosDaClasse(XElement root)
        {
            ...
            if (metodosDaClasse != null)
            {
                ...
                foreach (Metodo umaFuncaoDaClasse in metodosDaClasse)
                {
